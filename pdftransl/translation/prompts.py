"""Все промпты: перевод, исправление, ревью, описание рисунков.

Системный переводческий промпт несёт правила плейсхолдеров и
markdown-структуры; сюда же подмешиваются глоссарий, примеры из TM и
саммари документа.
"""
