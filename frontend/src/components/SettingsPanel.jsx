// Серверные настройки «на лету»: провайдер, модели, парсер, воркеры,
// rpm, форматы, поведение пайплайна, уровень логов. PUT /api/settings/ —
// применяется к новым задачам без перезапуска сервера.
